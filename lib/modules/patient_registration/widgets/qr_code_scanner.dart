...
import 'package:follo_patient_app/modules/patient_registration/patient_registration.dart';
    ...
    if (result == null) {
      controller.scannedDataStream.listen((scanData) async {
        ...
        if (result != null && result.code != '') {
          if (result.code.contains("?ci=") && result.code.contains("&cti=") && result.code.contains("&cgi=")) {
            controller.pauseCamera();
            Uri uri = Uri.dataFromString(result.code); //converts string to a uri
            ...
            print("navigaton called");
            await Navigator.pushReplacement(
              context,
              MaterialPageRoute(
                builder: (BuildContext context) => CreateFolloPatientPage(
                  clinicId: clinicId,
            ...
            AwesomeDialog(
              ...
              desc: "Please scan valid QR Code",
              btnOkOnPress: () {},
            )..show();
          }
        }
